...
class DesignState:
    def __init__(self, top_node: AddrmapNode) -> None:
        ...
        self.jj_env = jj.Environment(loader=loader, undefined=jj.StrictUndefined)
